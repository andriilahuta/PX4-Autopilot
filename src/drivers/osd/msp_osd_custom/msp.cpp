...
msp_osd_buffer MspEncoder::encodeV1(msp_osd_buffer& headerBuff, const msp_osd_buffer& dataBuff,
    ...
    */
    ...
    if (dataSize >= MSP_JUMBO_FRAME_SIZE_LIMIT) {
        msp_osd_buffer jumboSize = msp_osd_utils::to_bytes(static_cast<uint16_t>(dataSize), true);
        headerBuff.insert(headerBuff.end(), jumboSize.begin(), jumboSize.end());
    }
...
msp_osd_buffer MspEncoder::encodeV2overV1(msp_osd_buffer& headerBuff, const msp_osd_buffer& dataBuff,
    ...
    msp_osd_buffer hdrV2Cmd = msp_osd_utils::to_bytes(static_cast<uint16_t>(command), true);
    msp_osd_buffer hdrV2Size = msp_osd_utils::to_bytes(static_cast<uint16_t>(dataBuff.size()), true);
    headerV2Buff.insert(headerV2Buff.end(), hdrV2Cmd.begin(), hdrV2Cmd.end());
    headerV2Buff.insert(headerV2Buff.end(), hdrV2Size.begin(), hdrV2Size.end());
    headerBuff.insert(headerBuff.end(), headerV2Buff.begin(), headerV2Buff.end());

    if (payloadSize >= MSP_JUMBO_FRAME_SIZE_LIMIT) {
        msp_osd_buffer jumboSize = msp_osd_utils::to_bytes(static_cast<uint16_t>(payloadSize), true);
        headerBuff.insert(headerBuff.end(), jumboSize.begin(), jumboSize.end());
    }
...
msp_osd_buffer MspEncoder::encodeV2(msp_osd_buffer& headerBuff, const msp_osd_buffer& dataBuff,
    ...
    */
    ...
    headerBuff.insert(headerBuff.end(), hdrV2Cmd.begin(), hdrV2Cmd.end());
    headerBuff.insert(headerBuff.end(), hdrV2Size.begin(), hdrV2Size.end());
